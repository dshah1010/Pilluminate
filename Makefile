#############################################################################
# Makefile for building: Pilluminate.app/Contents/MacOS/Pilluminate
# Generated by qmake (3.1) (Qt 6.6.1)
# Project:  Pilluminate.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile Pilluminate.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Pilluminate1.0.0
DISTDIR = /Users/deepshah/Desktop/group3/Pilluminate/.tmp/Pilluminate1.0.0
...
SOURCES       = src/interfaces/UserInterface.cpp \
		...
		src/main.cpp moc_UserInterface.cpp \
		moc_VirtualLED.cpp
OBJECTS       = UserInterface.o \
		VirtualLED.o \
		main.o \
		moc_UserInterface.o \
		moc_VirtualLED.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		Pilluminate.pro include/interfaces/UserInterface.h \
		include/models/VirtualLED.h src/interfaces/UserInterface.cpp \
		src/models/VirtualLED.cpp \
		src/main.cpp
QMAKE_TARGET  = Pilluminate
DESTDIR       = 
TARGET        = Pilluminate.app/Contents/MacOS/Pilluminate

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/deepshah/Desktop/group3/Pilluminate/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/deepshah/Desktop/group3/Pilluminate/Pilluminate.pro
...
Pilluminate.app/Contents/MacOS/Pilluminate:  $(OBJECTS)  
	@test -d Pilluminate.app/Contents/MacOS/ || mkdir -p Pilluminate.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Pilluminate.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.6.1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.1/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile Pilluminate.pro
...
Pilluminate.app/Contents/PkgInfo: 
	@test -d Pilluminate.app/Contents || mkdir -p Pilluminate.app/Contents
	@$(DEL_FILE) Pilluminate.app/Contents/PkgInfo
	@echo "APPL????" > Pilluminate.app/Contents/PkgInfo
Pilluminate.app/Contents/Info.plist: 
	@test -d Pilluminate.app/Contents || mkdir -p Pilluminate.app/Contents
	@$(DEL_FILE) Pilluminate.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Pilluminate,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Pilluminate,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Pilluminate,g" -e "s,@LIBRARY@,Pilluminate,g" -e "s,\$${EXECUTABLE_NAME},Pilluminate,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Pilluminate.app/Contents/Info.plist

all: Makefile \
		Pilluminate.app/Contents/PkgInfo \
		Pilluminate.app/Contents/Info.plist Pilluminate.app/Contents/MacOS/Pilluminate
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/interfaces/UserInterface.h include/models/VirtualLED.h $(DISTDIR)/
	$(COPY_FILE) --parents src/interfaces/UserInterface.cpp src/models/VirtualLED.cpp src/main.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_UserInterface.cpp moc_VirtualLED.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_UserInterface.cpp moc_VirtualLED.cpp
moc_UserInterface.cpp: include/interfaces/UserInterface.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/deepshah/Desktop/group3/Pilluminate/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/deepshah/Desktop/group3/Pilluminate -I/Users/deepshah/Desktop/group3/Pilluminate/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib include/interfaces/UserInterface.h -o moc_UserInterface.cpp

moc_VirtualLED.cpp: include/models/VirtualLED.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QColor \
		/opt/homebrew/lib/QtGui.framework/Headers/qcolor.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/deepshah/Desktop/group3/Pilluminate/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/deepshah/Desktop/group3/Pilluminate -I/Users/deepshah/Desktop/group3/Pilluminate/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib include/models/VirtualLED.h -o moc_VirtualLED.cpp
...
UserInterface.o: src/interfaces/UserInterface.cpp include/interfaces/UserInterface.h \
		include/models/VirtualLED.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QColor \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UserInterface.o src/interfaces/UserInterface.cpp

VirtualLED.o: src/models/VirtualLED.cpp include/models/VirtualLED.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QColor \
		/opt/homebrew/lib/QtGui.framework/Headers/qcolor.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QInputDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qinputdialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o VirtualLED.o src/models/VirtualLED.cpp
...
moc_VirtualLED.o: moc_VirtualLED.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_VirtualLED.o moc_VirtualLED.cpp
